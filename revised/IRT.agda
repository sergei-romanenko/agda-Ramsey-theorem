...
corollary-05 R S h1 h2 h3 h4 = 
  lemma-01 (0# ∪ 0# ∪ R ∩ S) (R ∩ S)
    (λ xs → ⊥⊎⊥⊎A→A)
    (theorem-04 0# 0# R S
      h1 h2 
      (lemma-01 R (0# ∪ R) (λ xs h → inj₂ h) h3)
      (lemma-01 S (0# ∪ S) (λ xs h → inj₂ h) h4))
